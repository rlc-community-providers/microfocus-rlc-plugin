...
/**
 * Basic Release Control configuration
 *
 * @author Kevin A. Lee
 */
public class RLCConfiguration extends AbstractDescribableImpl<RLCConfiguration> {
    ...
    public RLCConfiguration(String aeUrl, String oeUrl) {
        this.aeUrl = aeUrl;
        this.oeUrl = oeUrl;
    }
    ...
    @Extension
    public static class DescriptorImpl extends Descriptor<RLCConfiguration> {
        @Override
        public String getDisplayName() {
            return "Micro Focus Release Control Configuration";
        }
    }
}
