...
/**
 * Step to get the state of a Release Package
 *
 * @author Kevin A. Lee
 */
public class GetReleasePackageStateStep extends AbstractRLCStep {

    @Extension
    public static final GetReleasePackageStateDescriptor DESCRIPTOR = new GetReleasePackageStateDescriptor();
    ...
    public GetReleasePackageStateStep(String siteName) {
        super(siteName);
    }
    ...
    @DataBoundSetter
    public void setReleasePackageId(final Integer releasePackageId) {
     ...
     *
     * <p>
     * See {@code src/main/resources/com/microfocus/jenkins/plugins/rlc/GetReleasePackageStateStep/*.jelly}
     * for the actual HTML fragment for the configuration screen.
     * </p>
     */
    @Symbol("rlcGetReleasePackageState")
    @Extension
    public static class GetReleasePackageStateDescriptor extends AbstractRLCDescriptorImpl {
        ...
        public String getDisplayName() {
            return "Micro Focus RLC Release Package State";
        }

        @Override
        public String getFunctionName() {
            return "rlcGetReleasePackageState";
        }
    ...
    public static final class Execution extends AbstractItemProviderExecution<String> {
        ...
        private transient GetReleasePackageStateStep step;

        Execution(@Nonnull StepContext context, @Nonnull GetReleasePackageStateStep step) {
            super(context);
            this.step = step;
        }
        ...
        protected String run() throws Exception {
            ...
            step.log("Retrieving state of Release Package [" + site.getReleasePackageTableId() + ":"
                    + step.getReleasePackageId() + "]");
            ...
            UriBuilder uriBuilder = UriBuilder.fromPath(site.getAeUrl()).path("jsonapi").path("GetItem")
                    .path(site.getReleasePackageTableId().toString())
                    .path(step.getReleasePackageId().toString());
                        ...
                        if (step.getWaitForState()) {
                            if (StringUtils.equalsIgnoreCase(stateVal, step.getDesiredState())) {
                                ...
                                if (step.getMaxRetries() != -1 && ++numTries == step.getMaxRetries()) {
                                    ...
                                    step.log("Current State of Release Package \"" + titleVal + "\" is: " + stateVal);
                                    try {
            ...
            step.log("State of Release Package \"" + titleVal + "\" is now: " + stateVal);
